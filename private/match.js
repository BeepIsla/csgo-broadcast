...
server.get("/:token/:fragmentNumber/:frameType", (req, res) => {
	...
	if (req.params.frameType === "start") {
		...
		console.log("Start playcast for match " + req.params.token + " and fragment " + req.params.fragmentNumber + " with frame type " + req.params.frameType + " for user " + req.connection.remoteAddress);
	}
